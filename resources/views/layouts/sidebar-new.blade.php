<aside class="vertical-nav bg-white" id="sidebar">
    ...
    <p class="text-gray font-weight-bold text-uppercase px-3 small mb-0">Dasbor</p>
    ...
    <p class="text-gray font-weight-bold text-uppercase px-3 pt-2 small mb-0">Metode Pembayaran</p>
    <ul class="nav flex-column bg-white mb-0">
        <li class="nav-item">
    ...
    <footer class="footer mt-2">
        <div class="w-100">
            <div class="text-center">
                <small>Designed &amp; Developed</small>
            </div>
            <div class="text-center">
                Free to Use
            </div>
